...
function _fetchData(connection, body, processFunc) {
  ...
  if (typeof connection === "string") {
    ...
    if (connection.user != null && connection.password != null) {
      if (url.substring(0, 6) !== "https:" && connection.allowInsecureAuthentication !== true) {
        logger3.throwError("basic authentication requires a secure https url", Logger.errors.INVALID_ARGUMENT, { argument: "url", url, user: connection.user, password: "[REDACTED]" });
      }
  ...
  if (dataMatch) {
    try {
      ...
      logger3.throwError("processing response error", Logger.errors.SERVER_ERROR, {
    ...
    const promise = new Promise(function(resolve, reject) {
      if (timeout) {
        timer2 = setTimeout(() => {
          ...
          timer2 = null;
          reject(logger3.makeError("timeout", Logger.errors.TIMEOUT, {
  ...
  const runningFetch = function() {
    return __awaiter2(this, void 0, void 0, function* () {
      for (let attempt = 0; attempt < attemptLimit; attempt++) {
        ...
        try {
          ...
          if (response == null) {
            ...
            logger3.throwError("missing response", Logger.errors.SERVER_ERROR, {
              requestBody: bodyify(options.body, flatHeaders["content-type"]),
              requestMethod: options.method,
              serverError: error,
              url
        ...
        if (allow304 && response.statusCode === 304) {
          ...
          runningTimeout.cancel();
          logger3.throwError("bad response", Logger.errors.SERVER_ERROR, {
      ...
      return logger3.throwError("failed response", Logger.errors.SERVER_ERROR, {
        requestBody: bodyify(options.body, flatHeaders["content-type"]),
        requestMethod: options.method,
        url
      });
  ...
  let processJsonFunc = (value, response) => {
    ...
    if (value != null) {
      try {
        ...
        logger3.throwError("invalid JSON", Logger.errors.SERVER_ERROR, {
          body: value,
          error
        });
      }
...
var init_ws = __esm({
  "node_modules/@ethersproject/providers/lib.esm/ws.js"() {
    ...
    try {
      ...
      const logger18 = new Logger(version2);
      WS = function() {
...
//# sourceMappingURL=chunk-UYAXO34Q.js.map
