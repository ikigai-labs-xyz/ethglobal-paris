...
function H(_a) {
  var _b = _a, { visible: r4 = true, features: t6 = 0, ourProps: e4, theirProps: o3 } = _b, i4 = __objRest(_b, ["visible", "features", "ourProps", "theirProps"]);
  var a6;
  ...
  if (t6 & 1) {
    ...
    return u(d8, { [0]() {
      ...
      return y(__spreadProps(__spreadValues({}, i4), { props: __spreadProps(__spreadValues({}, n6), { hidden: true, style: { display: "none" } }) }));
    } });
  }
  return y(l4);
}
function y({ props: r4, attrs: t6, slots: e4, slot: o3, name: i4 }) {
  var m5, h3;
  let _a = T(r4, ["unmount", "static"]), { as: n6 } = _a, l4 = __objRest(_a, ["as"]), a6 = (m5 = e4.default) == null ? void 0 : m5.call(e4, o3), d8 = {};
  if (o3) {
    let u6 = false, c6 = [];
...
var f2 = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(r4, { slots: t6, attrs: d8 }) {
  return () => {
    let _a = r4, { features: e4 } = _a, o3 = __objRest(_a, ["features"]), n6 = { "aria-hidden": (e4 & 2) === 2 ? true : void 0, style: __spreadValues({ position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, (e4 & 4) === 4 && (e4 & 2) !== 2 && { display: "none" }) };
...
var Ne = defineComponent({ name: "Combobox", emits: { "update:modelValue": (o3) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => be }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o3, { slots: O2, attrs: s3, emit: P4 }) {
  ...
  return onMounted(() => {
    ...
    let _a = o3, { name: n6, disabled: r4, form: p7 } = _a, a6 = __objRest(_a, ["name", "disabled", "form"]), v4 = { open: e4.value === 0, disabled: r4, activeIndex: u6.activeOptionIndex.value, activeOption: L5.value, value: b4.value };
    return h(Fragment, [...n6 != null && b4.value != null ? e2({ [n6]: b4.value }).map(([g5, A3]) => h(f2, K({ features: a2.Hidden, key: g5, as: "input", type: "hidden", hidden: true, readOnly: true, form: p7, name: g5, value: A3 }))) : [], H({ theirProps: __spreadValues(__spreadValues({}, s3), T(a6, ["modelValue", "defaultValue", "nullable", "multiple", "onUpdate:modelValue", "by"])), ourProps: {}, slot: v4, slots: O2, attrs: s3, name: "Combobox" })]);
  };
} });
var He = defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-combobox-label-${t()}` } }, setup(o3, { attrs: O2, slots: s3 }) {
  ...
  return () => {
    let t6 = { open: P4.comboboxState.value === 0, disabled: P4.disabled.value }, _a = o3, { id: f4 } = _a, I3 = __objRest(_a, ["id"]), d8 = { id: f4, ref: P4.labelRef, onClick: e4 };
...
var Ke = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-combobox-button-${t()}` } }, setup(o3, { attrs: O2, slots: s3, expose: P4 }) {
  ...
  return () => {
    var y4, h3;
    let d8 = { open: e4.comboboxState.value === 0, disabled: e4.disabled.value, value: e4.value.value }, _a = o3, { id: c6 } = _a, x4 = __objRest(_a, ["id"]), S5 = { ref: e4.buttonRef, id: c6, type: I3.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (y4 = o2(e4.optionsRef)) == null ? void 0 : y4.id, "aria-expanded": e4.disabled.value ? void 0 : e4.comboboxState.value === 0, "aria-labelledby": e4.labelRef.value ? [(h3 = o2(e4.labelRef)) == null ? void 0 : h3.id, c6].join(" ") : void 0, disabled: e4.disabled.value === true ? true : void 0, onKeydown: f4, onClick: t6 };
...
var $e = defineComponent({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: () => `headlessui-combobox-input-${t()}` } }, emits: { change: (o3) => true }, setup(o3, { emit: O2, attrs: s3, slots: P4, expose: e4 }) {
  ...
  return () => {
    ...
    let l4 = { open: t6.comboboxState.value === 0 }, _a = o3, { id: i4, displayValue: b4, onChange: w3 } = _a, u6 = __objRest(_a, ["id", "displayValue", "onChange"]), L5 = { "aria-controls": (D = t6.optionsRef.value) == null ? void 0 : D.id, "aria-expanded": t6.disabled.value ? void 0 : t6.comboboxState.value === 0, "aria-activedescendant": t6.activeOptionIndex.value === null || (n6 = t6.options.value[t6.activeOptionIndex.value]) == null ? void 0 : n6.id, "aria-labelledby": (a6 = (r4 = o2(t6.labelRef)) == null ? void 0 : r4.id) != null ? a6 : (p7 = o2(t6.buttonRef)) == null ? void 0 : p7.id, "aria-autocomplete": "list", id: i4, onCompositionstart: c6, onCompositionend: x4, onKeydown: S5, onInput: y4, onBlur: h3, role: "combobox", type: (v4 = s3.type) != null ? v4 : "text", tabIndex: 0, ref: t6.inputRef, defaultValue: E6.value, disabled: t6.disabled.value === true ? true : void 0 };
...
var ce2 = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e4, { attrs: t6, slots: l4, expose: o3 }) {
  ...
  return () => {
    let a6 = {}, d8 = { ref: r4, onKeydown: H5, onFocusout: M2 }, _a = e4, { features: E6, initialFocus: g5, containers: X3 } = _a, O2 = __objRest(_a, ["features", "initialFocus", "containers"]);
    return h(Fragment, [Boolean(E6 & 4) && h(f2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u6, features: a2.Focusable }), H({ ourProps: d8, theirProps: __spreadValues(__spreadValues({}, t6), O2), slot: a6, attrs: t6, slots: l4, name: "FocusTrap" }), Boolean(E6 & 4) && h(f2, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u6, features: a2.Focusable })]);
  };
} }), { features: A });
var L = [];
t4(() => {
...
var P2 = defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(o3, { slots: t6, attrs: r4 }) {
  return provide(e3, o3.force), () => {
    let _a = o3, { force: f4 } = _a, n6 = __objRest(_a, ["force"]);
...
var L2 = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(t6, { attrs: r4, slots: o3 }) {
  ...
  return provide(g, e4), () => {
    let _a = t6, { target: p7 } = _a, n6 = __objRest(_a, ["target"]);
...
var E4 = defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${t()}` } }, setup(t6, { attrs: i4, slots: o3 }) {
  ...
  return onMounted(() => onUnmounted(e4.register(t6.id))), () => {
    let { name: s3 = "Description", slot: n6 = ref({}), props: r4 = {} } = e4, _a = t6, { id: d8 } = _a, l4 = __objRest(_a, ["id"]), c6 = __spreadProps(__spreadValues({}, Object.entries(r4).reduce((f4, [a6, g5]) => Object.assign(f4, { [a6]: unref(g5) }), {})), { id: d8 });
...
var qe = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: H3 }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${t()}` } }, emits: { close: (r4) => true }, setup(r4, { emit: n6, attrs: l4, slots: p7, expose: i4 }) {
  ...
  return d4(O2, te3, (e4) => {
    ...
    let _a = r4, { id: e4, open: t6, initialFocus: u6 } = _a, s3 = __objRest(_a, ["id", "open", "initialFocus"]), g5 = __spreadProps(__spreadValues({}, l4), { ref: v4, id: e4, role: "dialog", "aria-modal": c6.value === 0 ? true : void 0, "aria-labelledby": M2.value, "aria-describedby": X3.value }), h3 = { open: c6.value === 0 };
...
var Ke2 = defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-overlay-${t()}` } }, setup(r4, { attrs: n6, slots: l4 }) {
  ...
  return () => {
    let _a = r4, { id: a6 } = _a, f4 = __objRest(_a, ["id"]);
...
var _e2 = defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${t()}` } }, inheritAttrs: false, setup(r4, { attrs: n6, slots: l4, expose: p7 }) {
  ...
  return p7({ el: a6, $el: a6 }), onMounted(() => {
    ...
    let _a = r4, { id: f4 } = _a, d8 = __objRest(_a, ["id"]), m5 = { id: f4, ref: a6, "aria-hidden": true };
    return h(P2, { force: true }, () => h(R, () => H({ ourProps: m5, theirProps: __spreadValues(__spreadValues({}, n6), d8), slot: { open: i4.dialogState.value === 0 }, attrs: n6, slots: l4, name: "DialogBackdrop" })));
  };
} });
var Ue2 = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${t()}` } }, setup(r4, { attrs: n6, slots: l4, expose: p7 }) {
  ...
  return () => {
    let _a = r4, { id: f4 } = _a, d8 = __objRest(_a, ["id"]), m5 = { id: f4, ref: i4.panelRef, onClick: a6 };
...
var Ye = defineComponent({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${t()}` } }, setup(r4, { attrs: n6, slots: l4 }) {
  ...
  return onMounted(() => {
    ...
    let _a = r4, { id: i4 } = _a, a6 = __objRest(_a, ["id"]);
...
var Q2 = defineComponent({ name: "Disclosure", props: { as: { type: [Object, String], default: "template" }, defaultOpen: { type: [Boolean], default: false } }, setup(t6, { slots: r4, attrs: o3 }) {
  ...
  return provide(x3, s3), c(computed(() => u(u6.value, { [0]: l.Open, [1]: l.Closed }))), () => {
    let _a = t6, { defaultOpen: l4 } = _a, a6 = __objRest(_a, ["defaultOpen"]), c6 = { open: u6.value === 0, close: s3.close };
...
var V = defineComponent({ name: "DisclosureButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-disclosure-button-${t()}` } }, setup(t6, { attrs: r4, slots: o3, expose: u6 }) {
  ...
  return () => {
    let n6 = { open: e4.disclosureState.value === 0 }, _a = t6, { id: S5 } = _a, k2 = __objRest(_a, ["id"]), K3 = s3.value ? { ref: l4, type: a6.value, onClick: c6, onKeydown: D } : { id: S5, ref: l4, type: a6.value, "aria-expanded": t6.disabled ? void 0 : e4.disclosureState.value === 0, "aria-controls": o2(e4.panel) ? e4.panelId.value : void 0, disabled: t6.disabled ? true : void 0, onClick: c6, onKeydown: D, onKeyup: T4 };
...
var X = defineComponent({ name: "DisclosurePanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-disclosure-panel-${t()}` } }, setup(t6, { attrs: r4, slots: o3, expose: u6 }) {
  ...
  return () => {
    let l4 = { open: e4.disclosureState.value === 0, close: e4.close }, _a = t6, { id: a6 } = _a, c6 = __objRest(_a, ["id"]), D = { id: a6, ref: e4.panel };
...
var je = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t6) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => de }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t6, { slots: b4, attrs: u6, emit: L5 }) {
  ...
  return onMounted(() => {
    ...
    let _a = t6, { name: a6, modelValue: l4, disabled: r4, form: s3 } = _a, S5 = __objRest(_a, ["name", "modelValue", "disabled", "form"]), k2 = { open: e4.value === 0, disabled: r4, value: y4.value };
    return h(Fragment, [...a6 != null && y4.value != null ? e2({ [a6]: y4.value }).map(([V2, $2]) => h(f2, K({ features: a2.Hidden, key: V2, as: "input", type: "hidden", hidden: true, readOnly: true, form: s3, name: V2, value: $2 }))) : [], H({ ourProps: {}, theirProps: __spreadValues(__spreadValues({}, u6), T(S5, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"])), slot: k2, slots: b4, attrs: u6, name: "Listbox" })]);
  };
} });
var Ae = defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-listbox-label-${t()}` } }, setup(t6, { attrs: b4, slots: u6 }) {
  ...
  return () => {
    let d8 = { open: L5.listboxState.value === 0, disabled: L5.disabled.value }, _a = t6, { id: m5 } = _a, x4 = __objRest(_a, ["id"]), f4 = { id: m5, ref: L5.labelRef, onClick: e4 };
...
var Fe = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-listbox-button-${t()}` } }, setup(t6, { attrs: b4, slots: u6, expose: L5 }) {
  ...
  return () => {
    var h3, y4;
    let o3 = { open: e4.listboxState.value === 0, disabled: e4.disabled.value, value: e4.value.value }, _a = t6, { id: i4 } = _a, w3 = __objRest(_a, ["id"]), R3 = { ref: e4.buttonRef, id: i4, type: f4.value, "aria-haspopup": "listbox", "aria-controls": (h3 = o2(e4.optionsRef)) == null ? void 0 : h3.id, "aria-expanded": e4.disabled.value ? void 0 : e4.listboxState.value === 0, "aria-labelledby": e4.labelRef.value ? [(y4 = o2(e4.labelRef)) == null ? void 0 : y4.id, i4].join(" ") : void 0, disabled: e4.disabled.value === true ? true : void 0, onKeydown: d8, onKeyup: m5, onClick: x4 };
...
var Ke3 = defineComponent({ name: "ListboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-listbox.option-${t()}` } }, setup(t6, { slots: b4, attrs: u6, expose: L5 }) {
  ...
  return () => {
    let { disabled: n6 } = t6, p7 = { active: m5.value, selected: x4.value, disabled: n6 }, _a = t6, { id: a6, value: l4, disabled: r4 } = _a, s3 = __objRest(_a, ["id", "value", "disabled"]), S5 = { id: a6, ref: d8, role: "option", tabIndex: n6 === true ? void 0 : -1, "aria-disabled": n6 === true ? true : void 0, "aria-selected": x4.value, disabled: void 0, onClick: i4, onFocus: w3, onPointerenter: h3, onMouseenter: h3, onPointermove: y4, onMousemove: y4, onPointerleave: M2, onMouseleave: M2 };
...
var Se = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-menu-button-${t()}` } }, setup(a6, { attrs: b4, slots: l4, expose: g5 }) {
  ...
  return () => {
    var r4;
    let o3 = { open: e4.menuState.value === 0 }, _a = a6, { id: t6 } = _a, v4 = __objRest(_a, ["id"]), u6 = { ref: e4.buttonRef, id: t6, type: d8.value, "aria-haspopup": "menu", "aria-controls": (r4 = o2(e4.itemsRef)) == null ? void 0 : r4.id, "aria-expanded": a6.disabled ? void 0 : e4.menuState.value === 0, onKeydown: m5, onKeyup: s3, onClick: p7 };
...
var be2 = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-menu-items-${t()}` } }, setup(a6, { attrs: b4, slots: l4, expose: g5 }) {
  ...
  return () => {
    var n6, i4;
    let t6 = { open: e4.menuState.value === 0 }, _a = a6, { id: v4 } = _a, u6 = __objRest(_a, ["id"]), r4 = { "aria-activedescendant": e4.activeItemIndex.value === null || (n6 = e4.items.value[e4.activeItemIndex.value]) == null ? void 0 : n6.id, "aria-labelledby": (i4 = o2(e4.buttonRef)) == null ? void 0 : i4.id, id: v4, onKeydown: s3, onKeyup: p7, role: "menu", tabIndex: 0, ref: e4.itemsRef };
...
var Me = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-menu-item-${t()}` } }, setup(a6, { slots: b4, attrs: l4, expose: g5 }) {
  ...
  return () => {
    let { disabled: n6 } = a6, i4 = { active: s3.value, disabled: n6, close: e4.closeMenu }, _a = a6, { id: I3 } = _a, M2 = __objRest(_a, ["id"]);
    return H({ ourProps: { id: I3, ref: m5, role: "menuitem", tabIndex: n6 === true ? void 0 : -1, "aria-disabled": n6 === true ? true : void 0, disabled: void 0, onClick: d8, onFocus: o3, onPointerenter: v4, onMouseenter: v4, onPointermove: u6, onMousemove: u6, onPointerleave: r4, onMouseleave: r4 }, theirProps: __spreadValues(__spreadValues({}, l4), M2), slot: i4, attrs: l4, slots: b4, name: "MenuItem" });
  };
} });
...
var Be2 = defineComponent({ name: "PopoverButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-popover-button-${t()}` } }, inheritAttrs: false, setup(c6, { attrs: m5, slots: p7, expose: y4 }) {
  ...
  return () => {
    ...
    return h(Fragment, [H({ ourProps: v4, theirProps: __spreadValues(__spreadValues({}, m5), u6), slot: t6, attrs: m5, slots: p7, name: "PopoverButton" }), n6 && !s3.value && o3.isPortalled.value && h(f2, { id: P4, features: a2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: $2 })]);
  };
} });
...
var He2 = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-popover-panel-${t()}` } }, inheritAttrs: false, setup(c6, { attrs: m5, slots: p7, expose: y4 }) {
  ...
  return () => {
    let i4 = { open: e4.popoverState.value === 0, close: e4.close }, _a = c6, { id: n6, focus: t6 } = _a, r4 = __objRest(_a, ["id", "focus"]), u6 = { ref: e4.panel, id: n6, onKeydown: P4, onFocusout: o3 && e4.popoverState.value === 0 ? a6 : void 0, tabIndex: -1 };
    return H({ ourProps: u6, theirProps: __spreadValues(__spreadValues({}, m5), r4), attrs: m5, slot: i4, slots: __spreadProps(__spreadValues({}, p7), { default: (...v4) => {
      var S5;
...
var T3 = defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-label-${t()}` } }, setup(t6, { slots: n6, attrs: i4 }) {
  let e4 = d5();
  return onMounted(() => onUnmounted(e4.register(t6.id))), () => {
    let { name: l4 = "Label", slot: r4 = {}, props: o3 = {} } = e4, _a = t6, { id: p7, passive: c6 } = _a, u6 = __objRest(_a, ["id", "passive"]), s3 = __spreadProps(__spreadValues({}, Object.entries(o3).reduce((f4, [b4, g5]) => Object.assign(f4, { [b4]: unref(g5) }), {})), { id: p7 });
...
var ke = defineComponent({ name: "RadioGroup", emits: { "update:modelValue": (t6) => true }, props: { as: { type: [Object, String], default: "div" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => re }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, id: { type: String, default: () => `headlessui-radiogroup-${t()}` } }, inheritAttrs: false, setup(t6, { emit: c6, attrs: u6, slots: E6, expose: d8 }) {
  ...
  return onMounted(() => {
    ...
    let _a = t6, { disabled: e4, name: a6, id: n6, form: l4 } = _a, r4 = __objRest(_a, ["disabled", "name", "id", "form"]), b4 = { ref: s3, id: n6, role: "radiogroup", "aria-labelledby": R3.value, "aria-describedby": w3.value, onKeydown: m5 };
    return h(Fragment, [...a6 != null && f4.value != null ? e2({ [a6]: f4.value }).map(([T4, G2]) => h(f2, K({ features: a2.Hidden, key: T4, as: "input", type: "hidden", hidden: true, readOnly: true, form: l4, name: T4, value: G2 }))) : [], H({ ourProps: b4, theirProps: __spreadValues(__spreadValues({}, u6), T(r4, ["modelValue", "defaultValue", "by"])), slot: {}, attrs: u6, slots: E6, name: "RadioGroup" })]);
  };
} });
...
var Ee = defineComponent({ name: "RadioGroupOption", props: { as: { type: [Object, String], default: "div" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-radiogroup-option-${t()}` } }, setup(t6, { attrs: c6, slots: u6, expose: E6 }) {
  ...
  return () => {
    let _a = t6, { id: r4, value: b4, disabled: T4 } = _a, G2 = __objRest(_a, ["id", "value", "disabled"]), N6 = { checked: v4.value, disabled: m5.value, active: Boolean(f4.value & 2) }, K3 = { id: r4, ref: R3, role: "radio", "aria-checked": v4.value ? "true" : "false", "aria-labelledby": s3.value, "aria-describedby": i4.value, "aria-disabled": m5.value ? true : void 0, tabIndex: e4.value, onClick: m5.value ? void 0 : a6, onFocus: m5.value ? void 0 : n6, onBlur: m5.value ? void 0 : l4 };
...
var ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l4) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: () => `headlessui-switch-${t()}` } }, inheritAttrs: false, setup(l4, { emit: p7, attrs: a6, slots: o3, expose: f4 }) {
  ...
  return onMounted(() => {
    ...
    let _a = l4, { id: e4, name: n6, value: L5, form: D } = _a, R3 = __objRest(_a, ["id", "name", "value", "form"]), K3 = { checked: i4.value }, x4 = { id: e4, ref: u6, role: "switch", type: g5.value, tabIndex: 0, "aria-checked": i4.value, "aria-labelledby": t6 == null ? void 0 : t6.labelledby.value, "aria-describedby": t6 == null ? void 0 : t6.describedby.value, onClick: k2, onKeyup: C2, onKeypress: E6 };
    return h(Fragment, [n6 != null && i4.value != null ? h(f2, K({ features: a2.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: i4.value, form: D, name: n6, value: L5 })) : null, H({ ourProps: x4, theirProps: __spreadValues(__spreadValues({}, a6), T(R3, ["modelValue", "defaultChecked"])), slot: K3, attrs: a6, slots: o3, name: "Switch" })]);
  };
} });
var de3 = T3;
var ce5 = E4;
...
var xe = defineComponent({ name: "TabGroup", emits: { change: (a6) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a6, { slots: v4, attrs: i4, emit: s3 }) {
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [n6.value.length <= 0 && h(d6, { onFocus: () => {
      ...
      return false;
    } }), H({ theirProps: __spreadValues(__spreadValues({}, i4), T(a6, ["selectedIndex", "defaultIndex", "manual", "vertical", "onChange"])), ourProps: {}, slot: t6, slots: v4, attrs: i4, name: "TabGroup" })]);
  };
} });
...
var ye2 = defineComponent({ name: "Tab", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-tabs-tab-${t()}` } }, setup(a6, { attrs: v4, slots: i4, expose: s3 }) {
  ...
  return () => {
    var p7;
    let e4 = { selected: m5.value }, _a = a6, { id: u6 } = _a, f4 = __objRest(_a, ["id"]), S5 = { ref: n6, onKeydown: R3, onMousedown: h3, onClick: w3, id: u6, role: "tab", type: t6.value, "aria-controls": (p7 = o2(l4.panels.value[b4.value])) == null ? void 0 : p7.id, "aria-selected": m5.value, tabIndex: m5.value ? 0 : -1, disabled: a6.disabled ? true : void 0 };
...
var ge2 = defineComponent({ name: "TabPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-tabs-panel-${t()}` }, tabIndex: { type: Number, default: 0 } }, setup(a6, { attrs: v4, slots: i4, expose: s3 }) {
  ...
  return () => {
    var t6;
    let r4 = { selected: m5.value }, _a = a6, { id: R3, tabIndex: y4 } = _a, w3 = __objRest(_a, ["id", "tabIndex"]), h3 = { ref: n6, id: R3, role: "tabpanel", "aria-labelledby": (t6 = o2(l4.tabs.value[b4.value])) == null ? void 0 : t6.id, tabIndex: m5.value ? y4 : -1 };
    return !m5.value && a6.unmount && !a6.static ? h(f2, __spreadValues({ as: "span" }, h3)) : H({ ourProps: h3, theirProps: w3, slot: r4, attrs: v4, slots: i4, features: N.Static | N.RenderStrategy, visible: m5.value, name: "TabPanel" });
  };
} });
...
var he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e4, { emit: t6, attrs: a6, slots: s3, expose: h3 }) {
  ...
  if (!me2() && C())
    return () => h(Se4, __spreadProps(__spreadValues({}, e4), { onBeforeEnter: r4, onAfterEnter: l4, onBeforeLeave: f4, onAfterLeave: S5 }), s3);
  ...
  return onMounted(() => {
    ...
    let _a = e4, { appear: o3, show: E6, enter: p7, enterFrom: V2, enterTo: Ce, entered: be3, leave: ye3, leaveFrom: Ee2, leaveTo: Ve } = _a, U3 = __objRest(_a, ["appear", "show", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), ne2 = { ref: d8 }, re2 = __spreadValues(__spreadValues({}, U3), A3.value && v4.value && c2.isServer ? { class: normalizeClass([a6.class, U3.class, ...j6, ...M2]) } : {});
...
var Se4 = defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e4, { emit: t6, attrs: a6, slots: s3 }) {
  ...
  return onMounted(() => {
    ...
    return H({ ourProps: __spreadProps(__spreadValues({}, b4), { as: "template" }), theirProps: {}, slot: {}, slots: __spreadProps(__spreadValues({}, s3), { default: () => [h(ce6, __spreadValues(__spreadValues(__spreadValues({ onBeforeEnter: () => t6("beforeEnter"), onAfterEnter: () => t6("afterEnter"), onBeforeLeave: () => t6("beforeLeave"), onAfterLeave: () => t6("afterLeave") }, a6), b4), d8), s3.default)] }), attrs: {}, features: W2, visible: r4.value === "visible", name: "Transition" });
  };
} });
...
//# sourceMappingURL=chunk-YEIPR2AD.js.map
