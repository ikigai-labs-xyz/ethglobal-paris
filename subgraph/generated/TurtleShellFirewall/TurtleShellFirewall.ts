...
export class FirewallStatusUpdate extends ethereum.Event {
  get params(): FirewallStatusUpdate__Params {
    return new FirewallStatusUpdate__Params(this);
  }
}

export class FirewallStatusUpdate__Params {
  _event: FirewallStatusUpdate;

  constructor(event: FirewallStatusUpdate) {
    this._event = event;
  }
...
export class TurtleShellFirewall__getSecurityParameterConfigOfResult {
  value0: i32;
  value1: BigInt;
...
export class TurtleShellFirewall extends ethereum.SmartContract {
  static bind(address: Address): TurtleShellFirewall {
    return new TurtleShellFirewall("TurtleShellFirewall", address);
  }
  ...
  getFirewallStatusOf(user: Address): boolean {
    let result = super.call(
      "getFirewallStatusOf",
      "getFirewallStatusOf(address):(bool)",
  ...
  try_getFirewallStatusOf(user: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "getFirewallStatusOf",
      "getFirewallStatusOf(address):(bool)",
      [ethereum.Value.fromAddress(user)]
  ...
  getSecurityParameterConfigOf(
    user: Address
  ): TurtleShellFirewall__getSecurityParameterConfigOfResult {
    let result = super.call(
      "getSecurityParameterConfigOf",
    ...
    return new TurtleShellFirewall__getSecurityParameterConfigOfResult(
      result[0].toI32(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new TurtleShellFirewall__getSecurityParameterConfigOfResult(
        value[0].toI32(),
        value[1].toBigInt()
      )
    );
...
export class SetFirewallStatusCall extends ethereum.Call {
  get inputs(): SetFirewallStatusCall__Inputs {
    return new SetFirewallStatusCall__Inputs(this);
  }

  get outputs(): SetFirewallStatusCall__Outputs {
    return new SetFirewallStatusCall__Outputs(this);
  }
}

export class SetFirewallStatusCall__Inputs {
  _call: SetFirewallStatusCall;

  constructor(call: SetFirewallStatusCall) {
    this._call = call;
  }
...
export class SetFirewallStatusCall__Outputs {
  _call: SetFirewallStatusCall;
